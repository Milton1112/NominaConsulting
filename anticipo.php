...
// Procedimiento almacenado para listar anticipos con filtros
$sql = "{CALL sp_listar_anticipo(?, ?)}";
$params = array(
...
<body>
    <header class="bg-primary text-white py-3 shadow-sm">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="text-center flex-grow-1">
                <h1 class="fs-3 mb-0 fw-bold">Lista de Anticipos</h1>
            </div>
        </div>
    </header>
        ...
        <div class="mx-auto p-4 bg-white rounded">
            ...
            <form method="POST" action="">
                <div class="row g-3 mb-3">
                    ...
                    <div class="col">
                        <input type="date" class="form-control" name="fecha" value="<?php echo isset($fecha) ? $fecha : ''; ?>">
                    </div>
                    <div class="col">
            ...
            <!-- Botón para agregar anticipos -->
            <div class="d-flex justify-content-end mb-3">
                <button class="btn btn-outline-secondary" id="agregarAnticipoBtn">Agregar anticipo</button>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-borderless align-middle">
                    ...
                    <tbody>
                        <?php if (sqlsrv_has_rows($stmt)) : ?>
                            <?php while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['fecha_solicitud']->format('Y-m-d'); ?></td>
                                    <td><?php echo $row['monto_solicitado']; ?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $row['id']; ?>">
                                                <li>
                                                    <a class="dropdown-item" href="templates/anticipo/editar_anticipo.php?id=<?php echo $row['id']; ?>">
                                                        <i class="fas fa-pencil-alt"></i> Editar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item text-danger" href="templates/anticipo/eliminar_anticipo.php?id=<?php echo $row['id']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar esto?');">
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="6" class="text-center text-muted py-3">No se encontraron anticipos</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    <script>
        document.getElementById('agregarAnticipoBtn').addEventListener('click', function() {
            ...
            if (dpiPasaporte !== null && dpiPasaporte.trim() !== "") {
                ...
                .then(data => {
                    if (data.existe) {
                        if (confirm("Empleado encontrado. ¿Desea agregar un anticipo?")) {
                            // Redirigir a agregar_anticipo.php con el id del empleado
                            window.location.href = 'templates/anticipo/agregar_anticipo.php?id=' + data.id_empleado;
                        }
                    } else {
