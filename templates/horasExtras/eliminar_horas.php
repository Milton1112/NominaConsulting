...
if (isset($_GET['id'])) {
    ...
    $sql = "{CALL sp_eliminar_horas_extras(?)}";
    $params = array(
    ...
    if ($stmt) {
        echo '<script>alert("Las Horas extras del empleado han sido eliminada correctamente."); window.location.href = "../../hora_extra.php";</script>';
    } else {
        ...
        if ($errorCode == 547) {
            echo '<script>alert("No se puede eliminar las horas extras. Por favor, intentarlo más tarde."); window.location.href = "../../hora_extra.php";</script>';
        } else {
