...
function insertarSalarioMensual($conn, $fk_id_empresa) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($sp_stmt) {
            echo '<script>alert("Salario mensual agregado exitosamente."); window.location.href = "../../../planilla.php";</script>';
        } else {
...
<body>
    <header class="bg-primary text-white py-3 shadow-sm">
        <div class="container d-flex justify-content-between align-items-center">
            <a href="../../../planilla.php" class="btn btn-outline-light d-flex align-items-center">Regresar</a>
