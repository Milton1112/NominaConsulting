    ...
    <header class="bg-primary text-white py-3 shadow-sm">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="text-center flex-grow-1">
                <h1 class="fs-3 mb-0 fw-bold">Actualizar Oficina</h1>
            </div>
        </div>
    </header>
    ...
    <div class="container mt-5 mb-5">
        <div class="card mx-auto rounded" style="max-width: 600px;">
            ...
            <div class="card-body">
                ...
                <div>
                    <div>
                        <label for="nombre" class="form-label">Nombre de la Oficna</label>
...
function actualizarOficina($conn){
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sp_params = array(
         ...
         $sp_stmt = sqlsrv_query($conn, "{CALL sp_actulizar_oficina(?,?)}", $sp_params);

          // Verificar si la ejecución fue exitosa
        if ($sp_stmt) {

            echo '<script>alert("Se ha actualizado la oficina."); window.location.href = "../../oficina.php";</script>';
