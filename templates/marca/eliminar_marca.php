...
if (isset($_GET['id'])) {
    ...
    if ($stmt) {
        echo '<script>alert("La Marca se ha sido eliminada correctamente."); window.location.href = "../../marca.php";</script>';
    } else {
        ...
        if ($errorCode == 547) {
            echo '<script>alert("No se puede eliminar esta marca porque está relacionada con uno o más productos. Por favor, elimine o actualice las referencias antes de intentarlo nuevamente."); window.location.href = "../../marca.php";</script>';
        } else {
