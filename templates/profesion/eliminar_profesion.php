...
if (isset($_GET['id'])) {
    ...
    $sql = "{CALL sp_eliminar_profesion(?)}";
    $params = array(
    ...
    if ($stmt) {
        echo '<script>alert("La profesión ha sido eliminada correctamente."); window.location.href = "../../profesion.php";</script>';
    } else {
        ...
        if ($errorCode == 547) {
            echo '<script>alert("No se puede eliminar esta profesión porque está relacionada con uno o más empleados. Por favor, elimine o actualice las referencias antes de intentarlo nuevamente."); window.location.href = "../../profesion.php";</script>';
        } else {
