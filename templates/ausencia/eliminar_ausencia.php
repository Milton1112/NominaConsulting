...
if (isset($_GET['id'])) {
    ...
    if ($stmt) {
        echo '<script>alert("El permiso del empleado ha sido eliminado correctamente."); window.location.href = "../../anticipo.php";</script>';
    } else {
        ...
        if ($errorCode == 547) {
            echo '<script>alert("No se puede eliminar el permiso. Por favor, intentarlo más tarde."); window.location.href = "../../anticipo.php";</script>';
        } else {
