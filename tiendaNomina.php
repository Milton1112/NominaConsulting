...
<body>
    <header class="bg-primary text-white py-3 shadow-sm">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a href="modules/logout.php" class="btn btn-outline-light d-flex align-items-center">
                <i class="bi bi-arrow-left-circle me-2"></i> Cerrar Sesión
            </a>
            <div class="text-center flex-grow-1">
                <h1 class="fs-3 mb-0 fw-bold">Tienda</h1>
            </div>
        </div>
    </header>
                        ...
                        <?php if (sqlsrv_has_rows($stmt)) : ?>
                            <?php while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['Nombre']; ?></td>
                                    <td>
                                        <button class="btn btn-success btn-sm rounded-pill px-3" onclick="window.location.href='templates/venta/vender_producto.php?id=<?php echo $row['id_producto']; ?>'">
