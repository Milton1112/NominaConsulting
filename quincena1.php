...
// Cambiamos el procedimiento almacenado a sp_quincena1
$sql = "{CALL sp_quincena1(?, ?)}";
$params = array(
...
<body>
    <header class="bg-primary text-white py-3 shadow-sm">
        <div class="container d-flex justify-content-center">
            <h1 class="fs-3 mb-0 fw-bold">Lista de Planilla - Quincena 1</h1>
        </div>
    </header>
                                                            ...
                                                            <tbody>
                                                                <?php foreach ($months[$month] as $row): ?>
                                                                    <tr class="shadow-sm rounded bg-light mb-2">
                                                                        ...
                                                                        <td><?php echo number_format($row['Liquido_Quincenal'], 2); ?></td>
